...
#ifdef BUILDING_MINI_AUDIO
  #define EXPCL_MINI_AUDIO EXPORT_CLASS
  #define EXPTP_MINI_AUDIO EXPORT_TEMPL
#else
  #define EXPCL_MINI_AUDIO IMPORT_CLASS
  #define EXPTP_MINI_AUDIO IMPORT_TEMPL
#endif
